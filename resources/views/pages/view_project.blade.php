        ...
        <div class="modal fade" id="addDocumentModal" tabindex="-1" role="dialog" aria-labelledby="ModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" style="max-width: 60%; min-width: 500px;" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ url("/admin/documents/store") }}" onsubmit="" id="taskDocumentForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group {{ $errors->has('file') ? 'has-error' : '' }}">
                                        ...
                                        <div class="needsclick dropzone dz-clickable" id="file-dropzone">
                                ...
                                <div class="col-md-3 form-group">
                                    <input id="submit-document" onclick="" type="button" class="btn btn-block center-block" style="background-color:#8a2a2b; color:white;" value="Submit">
                                </div>
