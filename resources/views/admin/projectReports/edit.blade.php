...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.projectReport.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.project-reports.update", [$projectReport->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
