...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.projectComment.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.project-comments.update", [$projectComment->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
