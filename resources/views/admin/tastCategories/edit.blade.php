...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tastCategory.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.tast-categories.update", [$tastCategory->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
